    ...
    case 'work-experience':
      return (
        <div>
          ...
          &amp;{' '}
          <span className="text-work_experience_orange">AI Developer</span>{' '}
          building projects &amp; competing in hackathons
        </div>
      );
    case 'skills':
      return (
        <div>
          <span className="text-skills_purple">Full Stack AI</span> developer
          with experience in <span className="text-skills_purple">AI/ML</span>,{' '}
          <span className="text-skills_purple">Frontend</span> &amp;{' '}
          <span className="text-skills_purple">Backend</span> technologies
        </div>
      );
    case 'projects':
      return (
        <div>
          ...
          stack <span className="text-my_work_yellow">AI</span> developer
        </div>
      );
    case 'contact':
      return (
          ...
          <BackgroundLines className="relative min-h-screen">
            <FadeIn className="max-w-5xl pt-60 md:pt-[20vh] 2xl:pt-[30vh]">
              ...
              <p className="text-md mx-auto max-w-xl text-center text-neutral-700 md:text-lg dark:text-neutral-400">
                Full Stack AI Developer building intelligent solutions from
                hackathons to production.
              </p>
            </FadeIn>
